...
export default async function PortfolioItemPage({params}: {params: Params} ) {
    ...
    return (
      ...
      <img src={portfolioItem.img} alt={portfolioItem.title} className="mb-6 rounded-lg" />
      ...
      <Link href="/portfolio" className="text-blue-500 underline">Back to Portfolio</Link>
    </section>
    )
}